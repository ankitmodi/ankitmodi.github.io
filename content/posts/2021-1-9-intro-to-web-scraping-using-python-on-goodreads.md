...
<img src="/assets/images/scraping_goodreads/my_books.png" alt="My Books Tab" style="width: 100%; height: auto;">

* Click on the *read* shelf

<img src="/assets/images/scraping_goodreads/read.png" alt="Read Shelf" style="width: 100%; height: auto;">


* Sort the book list by *date read*. Make sure that the sorting is in descending order. If not, click on *date read* again.

<img src="/assets/images/scraping_goodreads/sort_read.png" alt="Sort Read" style="width: 100%; height: auto;">
...
<img src="/assets/images/scraping_goodreads/table_book.png" alt="Table Book" style="width: 100%; height: auto;">
...
<img src="/assets/images/scraping_goodreads/cover_url.png" alt="Cover URL Parsing" style="width: 100%; height: auto;">
...
def create_markdown(filtered_and_sorted_book_list, year, intro_para,
    ...
    with open(md_file_path, 'w') as f:
        ...
        for i in range(len(filtered_and_sorted_book_list)):
            ...
            f.write(f"Author: <a href='{author_url}' target='_blank'>{author_name}</a>\n")
            f.write('<br>\n')
...
<img src="/assets/images/scraping_goodreads/book_para1.png" alt="Book Paragraph Output" style="width: 100%; height: auto;">
